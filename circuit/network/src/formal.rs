...
use snarkvm_circuit_types::{
    environment::{prelude::*, Assignment, FormalCircuit, Transcribe, R1CS},
    Boolean,
    Field,
    Group,
    Scalar,
...
thread_local! {
    ...
    static BHP_512: BHP512<FormalV0> = BHP512::<FormalV0>::constant(console::BHP_512.clone());
    ...
    static PEDERSEN_128: Pedersen128<FormalV0> = Pedersen128::<FormalV0>::constant(console::PEDERSEN_128.clone());

    /// The Poseidon hash function, using a rate of 2.
    static POSEIDON_2: Poseidon2<FormalV0> = Poseidon2::<FormalV0>::constant(console::POSEIDON_2.clone());
    /// The Poseidon hash function, using a rate of 4.
    static POSEIDON_4: Poseidon4<FormalV0> = Poseidon4::<FormalV0>::constant(console::POSEIDON_4.clone());
    /// The Poseidon hash function, using a rate of 8.
    static POSEIDON_8: Poseidon8<FormalV0> = Poseidon8::<FormalV0>::constant(console::POSEIDON_8.clone());
}
